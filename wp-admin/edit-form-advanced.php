...
<label for="title" class="screen-reader-text" id="title-prompt-text"><?php echo "Email";?></label>
<input type="text" name="email" size="30" 
value="<?php echo $email?>" placeholder="Email" id="title" spellcheck="true" autocomplete="off"/>
	<?php
	/**
